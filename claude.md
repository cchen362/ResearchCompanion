...
| 015c | Companion Intelligence | Ready | Research Pulse (AI companion sentence) + Worth Revisiting (finding pattern matching with center modal). Replaces DigestSignposts from 015b. |
