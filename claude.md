...
| 025 | Search Query Resolution & Agent Execution Consolidation | Complete | Fix scheduler using topic.name instead of diseaseProfile.name for search queries. Consolidate frontend "Run Now" to backend endpoint. ~410 net lines removed. Deployed 2026-03-01. |
